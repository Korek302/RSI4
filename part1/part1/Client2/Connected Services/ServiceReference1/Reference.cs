...
namespace Client2.ServiceReference1 {
    ...
    public interface IStrumien {
        ...
        Client2.ServiceReference1.ResponseFileMessage getMStream(Client2.ServiceReference1.RequestFileMessage request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStrumien/getMStream", ReplyAction="http://tempuri.org/IStrumien/getMStreamResponse")]
        System.Threading.Tasks.Task<Client2.ServiceReference1.ResponseFileMessage> getMStreamAsync(Client2.ServiceReference1.RequestFileMessage request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStrumienChannel : Client2.ServiceReference1.IStrumien, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StrumienClient : System.ServiceModel.ClientBase<Client2.ServiceReference1.IStrumien>, Client2.ServiceReference1.IStrumien {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Client2.ServiceReference1.ResponseFileMessage Client2.ServiceReference1.IStrumien.getMStream(Client2.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStream(request);
        }
        
        public string getMStream(string nazwa1, out long rozmiar, out System.IO.Stream dane) {
            Client2.ServiceReference1.RequestFileMessage inValue = new Client2.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
            Client2.ServiceReference1.ResponseFileMessage retVal = ((Client2.ServiceReference1.IStrumien)(this)).getMStream(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Client2.ServiceReference1.ResponseFileMessage> Client2.ServiceReference1.IStrumien.getMStreamAsync(Client2.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStreamAsync(request);
        }
        
        public System.Threading.Tasks.Task<Client2.ServiceReference1.ResponseFileMessage> getMStreamAsync(string nazwa1) {
            Client2.ServiceReference1.RequestFileMessage inValue = new Client2.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
            return ((Client2.ServiceReference1.IStrumien)(this)).getMStreamAsync(inValue);
        }
    }
}
